    ...
    <div className="flex w-full flex-col gap-6">
      ...
      <section className="border-y-2 border-zinc-200 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h1 className="text-3xl font-bold leading-tight text-zinc-900 sm:text-4xl font-head">
            {product.title}
          </h1>
          <div className="mt-3 flex flex-wrap items-center gap-3 text-sm text-zinc-600 font-text  ">
