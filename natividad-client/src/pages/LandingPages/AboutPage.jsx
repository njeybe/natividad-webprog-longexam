...
import tb from "../../assets/img/totebag.png";
...
const AboutPage = () => {
  return (
    <div className="flex w-full flex-col gap-6">
      <section className="border-y-2 border-zinc-200 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <img
            src={logo}
            alt="BulldogEx"
            className="h-80 w-175 border-2 border-zinc-200 bg-zinc-50 object-contain rounded-2xl"
          />
          ...
          <div>
            ...
            <h1 className="max-w-xl text-3xl font-bold leading-tight text-zinc-900 sm:text-4xl font-head">
              Your campus essentials, delivered through a cleaner experience.
            </h1>
            <p className="mt-4 max-w-lg text-sm leading-7 text-zinc-600 sm:text-base font-text">
              BulldogEx Shop embraces a high-utility, low-fidelity design to
      ...
      <section className="border-y-2 border-zinc-300 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="mb-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <div className="mt-6 space-y-4">
              <article className="rounded-3xl border-2 border-zinc-200 bg-zinc-100 p-5">
                <h3 className="text-lg font-semibold text-zinc-900 font-text">
                  Easy to Find
                </h3>
